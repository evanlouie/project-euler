...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__31460__auto__,writer__31461__auto__,opt__31462__auto__){
return cljs.core._write.call(null,writer__31461__auto__,"reagent.impl.template/NativeWrapper");
});
...
if(cljs.core.truth_((function (){var and__30777__auto__ = !((jsprops == null));
if(and__30777__auto__){
var and__30777__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__32986 = jsprops;
(G__32986["defaultValue"] = value);

(G__32986["onChange"] = ((function (G__32986,v,value,on_change){
...
var jsprops = ({"argv": v});
var temp__5461__auto___32993 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___32993 == null)){
} else {
var key_32994 = temp__5461__auto___32993;
(jsprops["key"] = key_32994);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__32995 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__32995["name"] = c);
...
var len__32068__auto___33000 = arguments.length;
var i__32069__auto___33001 = (0);
while(true){
if((i__32069__auto___33001 < len__32068__auto___33000)){
args__32075__auto__.push((arguments[i__32069__auto___33001]));

var G__33002 = (i__32069__auto___33001 + (1));
i__32069__auto___33001 = G__33002;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__32076__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq32998){
var G__32999 = cljs.core.first.call(null,seq32998);
var seq32998__$1 = cljs.core.next.call(null,seq32998);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__32999,seq32998__$1);
});
...
break;
default:
var G__33005 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__33005;
continue;
...
var n__31834__auto___33007 = a.length;
var i_33008 = (0);
while(true){
if((i_33008 < n__31834__auto___33007)){
(a[i_33008] = reagent.impl.template.as_element.call(null,(a[i_33008])));

var G__33009 = (i_33008 + (1));
i_33008 = G__33009;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31834__auto___33010 = a.length;
var i_33011 = (0);
while(true){
if((i_33011 < n__31834__auto___33010)){
var val_33012 = (a[i_33011]);
if((cljs.core.vector_QMARK_.call(null,val_33012)) && ((reagent.impl.template.key_from_vec.call(null,val_33012) == null))){
(o["no-key"] = true);
} else {
}

(a[i_33011] = reagent.impl.template.as_element.call(null,val_33012));
...
var ctx = ({});
var vec__33014 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__33014,(0),null);
var derefed = cljs.core.nth.call(null,vec__33014,(1),null);
...
var G__33017 = (cljs.core.count.call(null,argv) - first_child);
switch (G__33017) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__33017){
...
//# sourceMappingURL=template.js.map?rel=1511666489987
