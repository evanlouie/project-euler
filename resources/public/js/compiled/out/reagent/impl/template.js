...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__30767__auto__,writer__30768__auto__,opt__30769__auto__){
return cljs.core._write.call(null,writer__30768__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__32596 = o;
(G__32596[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__32598__i < G__32598__a.length) {G__32598__a[G__32598__i] = arguments[G__32598__i + 0]; ++G__32598__i;}
  args = new cljs.core.IndexedSeq(G__32598__a,0,null);
} 
...
if(cljs.core.truth_((function (){var and__30084__auto__ = !((jsprops == null));
if(and__30084__auto__){
var and__30084__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__32602 = jsprops;
(G__32602["defaultValue"] = value);

(G__32602["onChange"] = ((function (G__32602,v,value,on_change){
return (function (p1__32601_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__32601_SHARP_);
});})(G__32602,v,value,on_change))
);
...
var vec__32605 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__32605,(0),null);
var id = cljs.core.nth.call(null,vec__32605,(1),null);
var class$ = cljs.core.nth.call(null,vec__32605,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___32609 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___32609 == null)){
} else {
var key_32610 = temp__5461__auto___32609;
(jsprops["key"] = key_32610);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__32611 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__32611["name"] = c);
...
var len__31375__auto___32616 = arguments.length;
var i__31376__auto___32617 = (0);
while(true){
if((i__31376__auto___32617 < len__31375__auto___32616)){
args__31382__auto__.push((arguments[i__31376__auto___32617]));

var G__32618 = (i__31376__auto___32617 + (1));
i__31376__auto___32617 = G__32618;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31383__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq32614){
var G__32615 = cljs.core.first.call(null,seq32614);
var seq32614__$1 = cljs.core.next.call(null,seq32614);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__32615,seq32614__$1);
});
...
break;
default:
var G__32621 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__32621;
continue;
...
var n__31141__auto___32623 = a.length;
var i_32624 = (0);
while(true){
if((i_32624 < n__31141__auto___32623)){
(a[i_32624] = reagent.impl.template.as_element.call(null,(a[i_32624])));
...
var a = cljs.core.into_array.call(null,s);
var n__31141__auto___32626 = a.length;
var i_32627 = (0);
while(true){
if((i_32627 < n__31141__auto___32626)){
var val_32628 = (a[i_32627]);
if((cljs.core.vector_QMARK_.call(null,val_32628)) && ((reagent.impl.template.key_from_vec.call(null,val_32628) == null))){
(o["no-key"] = true);
} else {
}

(a[i_32627] = reagent.impl.template.as_element.call(null,val_32628));

var G__32629 = (i_32627 + (1));
i_32627 = G__32629;
continue;
} else {
}
...
var ctx = ({});
var vec__32630 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__32630,(0),null);
var derefed = cljs.core.nth.call(null,vec__32630,(1),null);
...
var G__32633 = (cljs.core.count.call(null,argv) - first_child);
switch (G__32633) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__32633){
...
//# sourceMappingURL=template.js.map?rel=1512625071843
