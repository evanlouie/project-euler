...
var or__30096__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj37202 = {"detail":data};
return obj37202;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30084__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30084__auto__)){
var and__30084__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__37209 = cljs.core._EQ_;
var expr__37210 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37209.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37210))){
return ((function (pred__37209,expr__37210){
return (function (p1__37203_SHARP_){
return console.warn(p1__37203_SHARP_);
});
;})(pred__37209,expr__37210))
} else {
if(cljs.core.truth_(pred__37209.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37210))){
return ((function (pred__37209,expr__37210){
return (function (p1__37204_SHARP_){
return console.debug(p1__37204_SHARP_);
});
;})(pred__37209,expr__37210))
} else {
if(cljs.core.truth_(pred__37209.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37210))){
return ((function (pred__37209,expr__37210){
return (function (p1__37205_SHARP_){
return console.error(p1__37205_SHARP_);
});
;})(pred__37209,expr__37210))
} else {
return ((function (pred__37209,expr__37210){
return (function (p1__37206_SHARP_){
return console.log(p1__37206_SHARP_);
});
;})(pred__37209,expr__37210))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37213){
...
var eval_fn = cljs.core.get.call(null,map__37214__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37216_SHARP_);
});})(new_def))
);
...
return (function (p__37217){
var vec__37218 = p__37217;
var ky = cljs.core.nth.call(null,vec__37218,(0),null);
...
if(cljs.core.truth_((function (){var and__30084__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1512625075965
