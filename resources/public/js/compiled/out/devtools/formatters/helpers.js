...
var G__38731 = devtools.prefs.pref.call(null,v);
v = G__38731;
continue;
} else {
return v;
...
var and__30777__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__30777__auto__){
var and__30777__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__30789__auto__ = (function (){try{if(!((value == null))){
...
}catch (e38734){var _e__37717__auto__ = e38734;
return false;
}})();
if(cljs.core.truth_(or__30789__auto__)){
return or__30789__auto__;
} else {
var or__30789__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e38738){var _e__37717__auto__ = e38738;
return false;
}})();
...
}catch (e38740){var _e__37717__auto__ = e38740;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__30777__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__30777__auto__)){
var and__30777__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__30777__auto____$1){
...
var and__30777__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__30777__auto__)){
...
var or__30789__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__30789__auto__)){
return or__30789__auto__;
} else {
...
var and__30777__auto__ = (function (){var or__30789__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__30789__auto__)){
return or__30789__auto__;
} else {
...
var and__30777__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__30777__auto__)){
...
var or__30789__auto__ = typeof value === 'string';
if(or__30789__auto__){
return or__30789__auto__;
} else {
var or__30789__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__38745_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__38745_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1511666494715
