...
var len__32068__auto___38751 = arguments.length;
var i__32069__auto___38752 = (0);
while(true){
if((i__32069__auto___38752 < len__32068__auto___38751)){
args__32075__auto__.push((arguments[i__32069__auto___38752]));

var G__38753 = (i__32069__auto___38752 + (1));
i__32069__auto___38752 = G__38753;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__32076__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq38749){
var G__38750 = cljs.core.first.call(null,seq38749);
var seq38749__$1 = cljs.core.next.call(null,seq38749);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__38750,seq38749__$1);
});
...
return (function (p1__38754_SHARP_){
return (p1__38754_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1511666494748
