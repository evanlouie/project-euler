...
var len__31375__auto___40791 = arguments.length;
var i__31376__auto___40792 = (0);
while(true){
if((i__31376__auto___40792 < len__31375__auto___40791)){
args__31382__auto__.push((arguments[i__31376__auto___40792]));

var G__40793 = (i__31376__auto___40792 + (1));
i__31376__auto___40792 = G__40793;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31383__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40788){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40789,G__40790,seq40788__$2);
});
...
if(cljs.core.truth_((function (){var or__30096__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__30767__auto__,writer__30768__auto__,opt__30769__auto__){
return cljs.core._write.call(null,writer__30768__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__30084__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__30084__auto__){
var or__30096__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__30096__auto__)){
return or__30096__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40794_SHARP_){
return !((cljs.core.meta.call(null,p1__40794_SHARP_) == null));
})))){
...
var map__40795 = opts;
var map__40795__$1 = ((((!((map__40795 == null)))?((((map__40795.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40795.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40795):map__40795);
var markup_db = cljs.core.get.call(null,map__40795__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__30096__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e40799){var _e__39748__auto__ = e40799;
return false;
}})();
if(cljs.core.truth_(or__30096__auto__)){
return or__30096__auto__;
...
}catch (e40801){var _e__39748__auto__ = e40801;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40803 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40804 = opts;
...
var markup_db = cljs.core.get.call(null,map__40804__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40803;
}});
...
;
var temp__5455__auto___40808 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___40808)){
var managed_print_level_40809 = temp__5455__auto___40808;
var _STAR_print_level_STAR_40807_40810 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40809;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40807_40810,managed_print_level_40809,temp__5455__auto___40808,writer,opts,job_fn){
return (function (p1__40806_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40806_SHARP_,null);
});})(_STAR_print_level_STAR_40807_40810,managed_print_level_40809,temp__5455__auto___40808,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40807_40810;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1512625079746
