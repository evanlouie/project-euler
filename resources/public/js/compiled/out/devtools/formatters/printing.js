...
var len__32068__auto___38760 = arguments.length;
var i__32069__auto___38761 = (0);
while(true){
if((i__32069__auto___38761 < len__32068__auto___38760)){
args__32075__auto__.push((arguments[i__32069__auto___38761]));

var G__38762 = (i__32069__auto___38761 + (1));
i__32069__auto___38761 = G__38762;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__32076__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38757){
var G__38758 = cljs.core.first.call(null,seq38757);
var seq38757__$1 = cljs.core.next.call(null,seq38757);
var G__38759 = cljs.core.first.call(null,seq38757__$1);
var seq38757__$2 = cljs.core.next.call(null,seq38757__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38758,G__38759,seq38757__$2);
});
...
if(cljs.core.truth_((function (){var or__30789__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__31460__auto__,writer__31461__auto__,opt__31462__auto__){
return cljs.core._write.call(null,writer__31461__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__30777__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__30777__auto__){
var or__30789__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__30789__auto__)){
return or__30789__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38763_SHARP_){
return !((cljs.core.meta.call(null,p1__38763_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__38764__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__30789__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e38768){var _e__37717__auto__ = e38768;
return false;
}})();
if(cljs.core.truth_(or__30789__auto__)){
return or__30789__auto__;
...
}catch (e38770){var _e__37717__auto__ = e38770;
return false;
}}
})())){
...
var _STAR_current_state_STAR_38772 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__38773 = opts;
...
var markup_db = cljs.core.get.call(null,map__38773__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_38772;
}});
...
;
var temp__5455__auto___38777 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___38777)){
var managed_print_level_38778 = temp__5455__auto___38777;
var _STAR_print_level_STAR_38776_38779 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_38778;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_38776_38779,managed_print_level_38778,temp__5455__auto___38777,writer,opts,job_fn){
return (function (p1__38775_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__38775_SHARP_,null);
});})(_STAR_print_level_STAR_38776_38779,managed_print_level_38778,temp__5455__auto___38777,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_38776_38779;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1511666494823
