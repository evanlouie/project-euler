...
var G__29335 = o;
(G__29335[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__29336__delegate = function (args){
...
while (G__29337__i < G__29337__a.length) {G__29337__a[G__29337__i] = arguments[G__29337__i + 0]; ++G__29337__i;}
  args = new cljs.core.IndexedSeq(G__29337__a,0,null);
} 
return G__29336__delegate.call(this,args);};
...
return G__29336__delegate(args);
});
...
var G__29339 = o;
(G__29339[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__29340__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__29341__i < G__29341__a.length) {G__29341__a[G__29341__i] = arguments[G__29341__i + 0]; ++G__29341__i;}
  args = new cljs.core.IndexedSeq(G__29341__a,0,null);
} 
return G__29340__delegate.call(this,args);};
G__29340.cljs$lang$maxFixedArity = 0;
G__29340.cljs$lang$applyTo = (function (arglist__29342){
var args = cljs.core.seq(arglist__29342);
return G__29340__delegate(args);
});
...
var G__29344 = props;
var G__29344__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29344,cljs.core.cst$kw$id,id):G__29344);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29344__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__29345){
...
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29346__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__29346,map__29346__$1,props,class$){
return (function (c){
...
});})(map__29346,map__29346__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__29348){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29349__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__29349,map__29349__$1,on_write){
return (function (){
...
});})(node_value,map__29349,map__29349__$1,on_write))
);
} else {
...
var G__29352 = jsprops;
(G__29352["defaultValue"] = value);

(G__29352["onChange"] = ((function (G__29352,v,value,on_change){
return (function (p1__29351_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__29351_SHARP_);
});})(G__29352,v,value,on_change))
);
...
var vec__29355 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29355,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29355,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29355,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___29359 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___29359 == null)){
} else {
var key_29360 = temp__5461__auto___29359;
(jsprops["key"] = key_29360);
}
...
var temp__5461__auto___29361 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___29361 == null)){
} else {
var key_29362 = temp__5461__auto___29361;
reagent.impl.template.oset(jsprops,"key",key_29362);
}
...
var G__29363 = reagent.impl.template.__GT_NativeWrapper();
(G__29363["name"] = c);
...
var G__29364 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__29364) : reagent.impl.template.as_element.call(null,G__29364));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq29367){
var G__29368 = cljs.core.first(seq29367);
var seq29367__$1 = cljs.core.next(seq29367);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29368,seq29367__$1);
});
...
break;
default:
var G__29374 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__29374;
continue;
...
var n__4376__auto___29376 = a.length;
var i_29377 = (0);
while(true){
if((i_29377 < n__4376__auto___29376)){
(a[i_29377] = reagent.impl.template.as_element((a[i_29377])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4376__auto___29379 = a.length;
var i_29380 = (0);
while(true){
if((i_29380 < n__4376__auto___29379)){
var val_29381 = (a[i_29380]);
if(((cljs.core.vector_QMARK_(val_29381)) && ((reagent.impl.template.key_from_vec(val_29381) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_29380] = reagent.impl.template.as_element(val_29381));
...
var ctx = ({});
var vec__29383 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29383,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29383,(1),null);
...
var G__29386 = (cljs.core.count(argv) - first_child);
switch (G__29386) {
case (0):
...
case (1):
var G__29387 = comp;
var G__29388 = jsprops;
var G__29389 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__29387,G__29388,G__29389) : reagent.impl.template.global$module$react.createElement.call(null,G__29387,G__29388,G__29389));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__29386){
