(defproject project-euler "0.1.0-SNAPSHOT"
  :description "Evan Louie's solutions to Project Euler questions"
  :url "https://github.com/evanlouie/project-euler"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "project-euler.core/on-js-reload"
